...
$(ConvertTo-SimpleBarChartsHtml -Charts @($data.competitive_landscape.charts) -SectionClass 'chart-grid--competitive')
    ...
    $(ConvertTo-CardGridHtml @($data.competitive_landscape.why_each_competitor_matters))
...
$(ConvertTo-RecommendationCardsHtml -Items @($data.brand_reputation.recommended_actions) -Tone 'teal')
