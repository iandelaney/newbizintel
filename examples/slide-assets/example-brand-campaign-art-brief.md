# Example Brand creative campaign artwork brief

- Brand slug: `example-brand`
- Delivery mode: `scaffold-allowed`
- Generation backend: `local-scaffold`
- Prompt manifest: `example-brand-campaign-illustration-prompts.json`
